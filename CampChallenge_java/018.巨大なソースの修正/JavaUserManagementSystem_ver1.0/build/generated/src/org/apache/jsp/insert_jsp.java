...
public final class insert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String tell    = "";
    String comment = "";
    String check   = (String)request.getAttribute("userbeans");
    
    if(!check.equals(null)){
        UserDataBeans userbeans = (UserDataBeans)request.getAttribute("userbeans");
        name    = userbeans.getName();
        year    = userbeans.getYear();
        month   = userbeans.getMonth();
        day     = userbeans.getDay();
        type    = userbeans.getType();
        tell    = userbeans.getTell();
        comment = userbeans.getComment();
    }
